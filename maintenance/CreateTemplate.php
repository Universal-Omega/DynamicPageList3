...
class CreateTemplate extends LoggedUpdateMaintenance {
	...
	protected function getUpdateKey(): string {
		return 'dynamic-page-list-4-create-template';
	}
	...
	/**
	 * Handle inserting DynamicPageList4's necessary template for content inclusion.
	 *
	 * @return bool
	 */
	protected function doDBUpdates(): bool {
		...
		if ( !$title->exists() ) {
			...
			$updater = $page->newPageUpdater(
				User::newSystemUser( 'DynamicPageList4 extension' )
			);
			...
			$comment = CommentStoreComment::newUnsavedComment(
				'Autogenerated DynamicPageList4\'s necessary template for content inclusion.'
			);
